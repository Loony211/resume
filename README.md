...
## Задание на семестр
1. Сайт на django по созданию документа из шаблона данные должны быть из бд,у всех должен быть шаблон справки об обучении и документ по командам,какие команды такие и документы
2. Численные методы линейная регрессия,обучение нейронки,участие в хакатоне ,ссылку на два степика на два курса
3. Конкупс траектория буд,ит планета или интеграция        #https://tbolimpiada.ru/onenews/241#
4. Сайты для администрации: видео интервью,памятная дата и тд
5. Работа с майскуэль
6. Компьютерные сети
